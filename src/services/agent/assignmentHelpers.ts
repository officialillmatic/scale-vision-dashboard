...
export const fetchAvailableUsers = async (): Promise<AssignmentUser[]> => {
  try {
    ...
    console.log('🔍 [fetchAvailableUsers] Users fetched:', data);
    return data || [];
  } catch (error: any) {
...
export const fetchAvailableAgents = async (): Promise<AssignmentAgent[]> => {
  try {
    console.log('🔍 [fetchAvailableAgents] Fetching agents from retell_agents');
    ...
    console.log('🔍 [fetchAvailableAgents] Agents fetched:', data);
    return data || [];
  } catch (error: any) {
