...
export default function DashboardPage() {
  ...
  debugLog('User:', user);
  debugLog('User metadata role:', user?.user_metadata?.role);
  ...
  const fetchAdminStats = async () => {
    try {
      ...
      debugLog('🔍 Fetching admin statistics...');
      ...
      debugLog('✅ Admin stats calculated:', calculatedAdminStats);
  ...
  const fetchCallsData = async () => {
    ...
    try {
      ...
      debugLog('🔍 Fetching calls data for regular user...');
      ...
      if (!userAgents || userAgents.length === 0) {
        debugLog('⚠️ No agents assigned to user');
        setCalls([]);
        setStats({
          totalCalls: 0,
          totalCost: 0,
      ...
      debugLog('👤 User agent IDs:', userAgentIds);
      ...
      debugLog('✅ User calls loaded:', callsData.length);
      ...
      if (callsData && callsData.length > 0) {
        ...
        debugLog('✅ User stats calculated:', {
          totalCalls,
          totalCost,
          completedCalls,
