...
Copy `.env.example` to `.env` and update the values before running the project. More details can be found in [docs/ENVIRONMENT_SETUP.md](docs/ENVIRONMENT_SETUP.md).
